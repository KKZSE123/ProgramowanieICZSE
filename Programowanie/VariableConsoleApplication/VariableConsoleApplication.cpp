...
void task10()
{
	float num_first, num_second, num_third, numWeight1, numWeight2, numWeight3, result;
...
void task12()
{
	...
	std::cout << "Prosze podaæ kwote";
	std::cin >> moneyFromUser;
	std::cout << "podaj kurs wymiany";
	std::cin >> exchangeRate;
	conversion = moneyFromUser * exchangeRate;
}
